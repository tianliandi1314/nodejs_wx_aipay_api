...
class OrderController extends Controller {
   ...
   * @apiParam  {String} sign 签名->加密方法 md5(md5(order_price + order_price) + secretkey)
  ...
  async create_order() {
    ...
    try {
      ...
      if (order_type === 'wechat') {
        ...
        const alipays = 'alipays://platformapi/startapp?appId=20000067&url=';
  ...
  async update() {
    ...
    try {
      ...
      await ctx.service.get_redirect_url(url);
    } catch (e) {
